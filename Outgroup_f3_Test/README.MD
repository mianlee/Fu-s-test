...
**Figure 4**: Outgroup-f3(Yoruba; LBK_EN, Y).
...
**Figure 5**: Outgroup-f3(Yoruba; LBKT_EN, Y).
...
**Figure 6**: Outgroup-f3(Yoruba; Starcevo_EN, Y).
...
**Figure 7**: Outgroup-f3(Yoruba; Spain_EN, Y).

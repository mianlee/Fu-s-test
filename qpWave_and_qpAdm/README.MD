...
Note that in order to use the ```admixr``` package, you need a working installation of ADMIXTOOLS! 
...
Again, the easiest wat to install the Admixtools package is to use ```conda``` :

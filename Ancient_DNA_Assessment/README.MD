...
It will install all ```mapDamage2``` dependencies automatically. However, I already had R installed on my computer and all dependent R libraries listed [here](https://ginolhac.github.io/mapDamage/):

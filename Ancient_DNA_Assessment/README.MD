...
High nucleotide misincorporation rates can be observed as a result of severe post-mortem DNA damage. Such misincorporation patterns are instrumental to authenticate ancient sequences versus modern contaminants. [mapDamage2](https://ginolhac.github.io/mapDamage/) is a computational framework written in Python and R, which tracks and quantifies DNA damage patterns among ancient DNA sequencing reads generated by Next-Generation Sequencing platforms. 

I follwed the [mapDamage2 homepage](https://ginolhac.github.io/mapDamage/) to install Requirements for mapDamage2 and then mapDamage2 itself. And I failed to run the mapDamage2, I think because of my system configuration issue, epecially I have miniconda and python3.6 installed, and I can connet ```pysam ``` to python2.7 in my system, even I installed ```pysam``` under phthon3.6.

So I created an conda envirment named "mapdamage":

```
conda create --name mapdamage
```

And I installed the program ```mapDamage2``` under mapdamage environment.
...
If you don't have miniconda installed, you can install Python 3.6 version of Miniconda [available here](https://docs.conda.io/en/latest/miniconda.html).
...
It displays the patterns of C -> T and G-> A changes across the DNA fragments of a given sample. For IndA for example:

**T** base reprensents by red, and **A** base reprensents by blue.
